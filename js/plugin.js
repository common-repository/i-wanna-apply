(function ($) {
	$(function () {
		...
		// If the "I wanna apply" is on this page, let's setup the event handler
		if(1 === $('#i-wanna-apply').length) {
			
			// We use the change attribute so that the event handler fires
			// whenever the checkbox or its associated label is clicked.
			$('button.i-wanna-apply').click(function (evt) {
